...
import { p as prependForwardSlash } from '../astro/assets-service_C3uvXEQO.mjs';
...
async function postNews(newsResponse) {
  ...
  Formik,
  {
    ...
    children: /* @__PURE__ */ jsxs(Form, { className: "text-sm text-textParagraph h-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx(ErrorMessage, { name: "title", component: "span", className: "text-warning" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx(ErrorMessage, { name: "subtitle", component: "span", className: "text-warning" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-1/3", children: [
        ...
        /* @__PURE__ */ jsx(ErrorMessage, { name: "description", component: "span", className: "text-warning" })
      ] }),
...
const vectorIcon = new Proxy({"src":"/_astro/vectorIcon.BRuvuf-u.svg","width":6,"height":10,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/SoyHenry/pf Litro/litro-ong/front/src/assets/vectorIcon.svg";
							}
...
const $$Index$4 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  console.log(news);
  return renderTemplate`${renderComponent($$result, "DasboardLayouts", $$DasboardLayouts, { "title": "DashboardAdmin - Un Litro Alta Gracia." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-row h-screen bg-secondary"> <div class="w-1/3 h-full pl-14 py-10"> ${renderComponent($$result2, "AsideMenuDasboard", $$AsideMenuDasboard, {}, { "default": ($$result3) => renderTemplate`<h3 class="text-3xl font-medium text-tertiary">Menu de Control</h3>` })} </div> <div class="2-m h-full  w-full px-14 py-10 flex flex-col "> <div class="shadown-3xl rounded-xl bg-textPrimary shadow-3xl p-10 h-full flex flex-col justify-between"> <h4 class="text-2xl font-medium text-tertiary mb-10 w-full text-end ">Seccion Noticias</h4> ${!news && renderTemplate`<p class="text-tertiary w-full text-center text-3xl">No hay noticias disponibles.</p>`} ${news && renderTemplate`<ul> ${news.map(
    ({ UrlImage, title, subtitle, date, location, href }, index) => renderTemplate`<li> <a class="flex flex-row justify-between p-10 items-center text-sm"${addAttribute(`card${index}`, "id")}${addAttribute(href, "href")}> <div class="flex"> <img${addAttribute(UrlImage, "src")}${addAttribute(title, "alt")} class="w-20 h-20 rounded-full object-cover mr-4"> <div> <h6 class="text-tertiary text-base font-semibold">${title}</h6> <p>${subtitle}</p> <p>${date}</p> </div> </div> <div> <p>${location}</p> </div> ${renderComponent($$result2, "Image", $$Image, { "src": vectorIcon, "alt": "icono de vector" })} </a> <hr> </li>`
  )} </ul>`} <div class="w-full flex justify-center"> <a href="/dashboardAdmin/newsCreate">${renderComponent($$result2, "ButtonCTASmall", $$ButtonCTASmall, { "title": "Agregar Noticia" })}</a> </div> </div> <div class="w-full flex justify-center mt-6"> <a href="/dashboardAdmin/volunteers">${renderComponent($$result2, "ButtonPrimarySmall", $$ButtonPrimarySmall, { "title": "Siguiente" })}</a> </div> </div> </div> ` })}`;
...
let lookupMap = {};
lookupMap = {"sponsors":{"type":"content","entries":{"becerra":"/src/content/sponsors/becerra.md","evi":"/src/content/sponsors/evi.md","cosag":"/src/content/sponsors/cosag.md","farmacia":"/src/content/sponsors/farmacia.md","jalisco":"/src/content/sponsors/jalisco.md"}},"notices":{"type":"content","entries":{"nuevotaller":"/src/content/notices/nuevoTaller.md","campañasolidaria":"/src/content/notices/campañaSolidaria.md","tallerdemusica":"/src/content/notices/tallerDeMusica.md"}},"tips":{"type":"content","entries":{"segundopost":"/src/content/tips/segundoPost.md","primerpost":"/src/content/tips/primerPost.md","sponsorpost":"/src/content/tips/sponsorPost.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/notices/campañaSolidaria.md": () => import('../campañaSolidaria_B-3mUD02.mjs'),"/src/content/notices/nuevoTaller.md": () => import('../nuevoTaller_DPL1XvO6.mjs'),"/src/content/notices/tallerDeMusica.md": () => import('../tallerDeMusica_DpmiV67b.mjs'),"/src/content/sponsors/becerra.md": () => import('../becerra_CqdrYWvV.mjs'),"/src/content/sponsors/cosag.md": () => import('../cosag_DQP9kWXC.mjs'),"/src/content/sponsors/evi.md": () => import('../evi_ClhEM6K0.mjs'),"/src/content/sponsors/farmacia.md": () => import('../farmacia_CsFs-lrL.mjs'),"/src/content/sponsors/jalisco.md": () => import('../jalisco_ClbYzYwe.mjs'),"/src/content/tips/primerPost.md": () => import('../primerPost_DSEWn56a.mjs'),"/src/content/tips/segundoPost.md": () => import('../segundoPost_D8TK9igj.mjs'),"/src/content/tips/sponsorPost.md": () => import('../sponsorPost_Cu7I4Xlc.mjs')});
