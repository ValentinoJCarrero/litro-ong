...
const NewsForHome: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="text-tertiary w-full text-center text-3xl">
        Cargando...
      </div>
    );
  }
  ...
  return (
    // <div className="flex flex-row flex-wrap bg-red-500 gap-12 items-center justify-center mb-10">
      <div className="flex flex-row gap-8 items-center justify-center m-2 flex-wrap  mb-10">
